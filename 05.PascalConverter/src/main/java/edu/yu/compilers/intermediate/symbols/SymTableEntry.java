...
public class SymTableEntry {
    ...
    private int slotNumber = -1; // local variable array slot
    ...
    public SymTableEntry(String name, Kind kind, SymTable symTable) {
        ...
        switch (kind) {
            case CONSTANT, VARIABLE, VALUE_PARAMETER, REFERENCE_PARAMETER,
                    RECORD_FIELD, ENUMERATION_CONSTANT -> {
                this.typespec = Predefined.noneType;
                info = new ValueInfo();
            }
            case FUNCTION, PROGRAM, PROCEDURE -> {
    ...
    /**
     * Returns true if the Kind of the entry is CONSTANT.
     */
    ...
    /**
     * Returns true if the Kind of the entry is FUNCTION.
     */
    ...
    /**
     * Returns true if the Kind of the entry is PROCEDURE.
     */
    ...
    /**
     * Returns true if the Kind of the entry is VARIABLE.
     */
    ...
    /**
     * Returns true if the Kind of the entry is VALUE_PARAMETER.
     */
    ...
    /**
     * Returns true if the Kind of the entry is REFERENCE_PARAMETER.
     */
    public boolean isReferenceParameter() {
        return kind == Kind.REFERENCE_PARAMETER;
    }
    ...
    /**
     * Get the local variable array slot number.
     */
    ...
    /**
     * Set the local variable array slot number.
     */
    ...
    /**
     * Get the routine code (DECLARED vs BUILT_IN).
     */
    public RoutineCode getRoutineCode() {
        return ((RoutineInfo) info).routineCode;
    }

    /**
     * Set the routine code.
     */
    public void setRoutineCode(RoutineCode routineCode) {
        ((RoutineInfo) info).routineCode = routineCode;
    }
     ...
     */
    public enum Kind {
        PROGRAM, PROGRAM_PARAMETER, CONSTANT, ENUMERATION_CONSTANT,
        TYPE, VARIABLE, RECORD_FIELD,
        VALUE_PARAMETER, REFERENCE_PARAMETER,
    ...
    /**
     * Routine code: whether the routine is user-declared or a built-in.
     */
    ...
    private static class RoutineInfo implements EntryInfo {
        ...
        private RoutineCode routineCode; // DECLARED or BUILT_IN
    }
}
